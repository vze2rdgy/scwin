...
namespace scwin
{
	...
	public ref class LabelAttributeValue sealed :
	...
	public:
		...
		virtual property Platform::Type ^ DataType { Type^ get() { return String::typeid; }}
	...
	typedef LabelAttributeValue MiscAttributeValue;
