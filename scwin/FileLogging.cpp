...
#define SCENARIO_PREFIX                     L"Streetcat_"
...
void scwin::FileLoggingSessionScenario::LogInfo(String ^ message)
{
	_channel->LogMessage(message, LoggingLevel::Information);
}

void scwin::FileLoggingSessionScenario::LogError(String ^ message)
{
	_channel->LogMessage(message, LoggingLevel::Error);
}

void scwin::FileLoggingSessionScenario::LogWarning(String ^ message)
{
	_channel->LogMessage(message, LoggingLevel::Warning);
}

void scwin::FileLoggingSessionScenario::LogCritical(String ^ message)
{
	_channel->LogMessage(message, LoggingLevel::Critical);
}
